  ...
  footer.innerHTML = `
      ...
      <div class="footer-locations">
        ...
        <div class="location-grid">
          ...
          <div class="location-item">
            <strong>서울 본점</strong>
            <!-- 전화번호 미확정으로 "안내 예정 (정식 번호 확정 전)" 문구를
                 노출했었으나(2026-09-15), 정식 번호 확정 전까지는 문구 자체를
                 화면에서 숨김(2026-09-16 사용자 요청) — placeholder 문구도
                 실제 안내처럼 보여 혼선 소지가 있다는 판단. 정식 번호 확정 시
                 주소 뒤에 "<br>실제 전화번호" 형태로 다시 추가할 것. -->
        ...
        <!-- "방문 전 예약을 권장합니다" 안내 문구 삭제 (2026-09-15, 사용자 요청). -->
    ...
    <div class="footer-bottom">
      <!-- 상호 표기 (2026-08-24 변경): 상호 변경(골든민트 → 원트로이불리온) 신고가
           ...
           "원트로이 불리온" 우선으로 변경 — 사용자 요청(2026-08-24). "등록상호:"
           라벨은 빼고 괄호 안에 "골든민트" 텍스트만 남김(2026-08-24 후속 요청).
           신고 완료 시 괄호 안 "/ 골든민트" 부분을 제거할 것. -->
      <p>© 2026 원트로이 불리온(ONETROY BULLION / 골든민트) 귀금속 전문점</p>
      ...
      <!-- 대표자명·사업자등록번호·주소·전화번호: 아코디언으로 전환(2026-08-24,
           ...
           전화번호는 미확정으로 "안내 예정" 문구로 대체했었으나(2026-09-15),
           정식 번호 확정 전까지는 이 줄 자체를 숨김(2026-09-16 사용자 요청)
           — 정식 번호 확정 시 <p>전화: 010-....-....</p> 형태로 복원할 것. -->
      <div class="footer-legal-details" id="footer-legal-details" hidden>
        <p>대표: 정세종</p>
        <p>사업자등록번호: 898-26-02365</p>
        <p>서울특별시 종로구 봉익동 136</p>
      </div>
      <!-- "귀금속은 투자 위험이 있습니다..." 투자 위험 고지 문구: 사용자 요청으로
           삭제함 (2026-08-24). -->
    </div>
  `;
