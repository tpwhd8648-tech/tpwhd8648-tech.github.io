      ...
      <div class="footer-locations">
        ...
        <div class="location-grid">
          ...
          <div class="location-item">
            <strong>서울 본점</strong>
            <!-- 전화번호 미확정으로 "안내 예정" 문구로 대체 (2026-09-15, 사용자 요청).
                 이전엔 가번호 "010-3737-5757 (임시)"를 노출했으나, 실제 존재하는
                 번호처럼 보여 혼선 소지가 있어 변경. 정식 번호 확정 시 이 문구를
                 실제 번호로 교체할 것. -->
            <p>서울특별시 종로구 봉익동 136<br>안내 예정 (정식 번호 확정 전)</p>
