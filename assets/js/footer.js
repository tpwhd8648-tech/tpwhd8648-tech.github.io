(function () {
  ...
  footer.innerHTML = `
    <div class="footer-inner">
      ...
      <div class="footer-locations">
        ...
        <div class="location-grid">
          <!-- 실제 주소·전화번호·영업시간 확정 반영 (2026-07-22) — 주소는 정식
               확정 전까지 종로3가역 인근 임시 주소. 영업시간은 매일 09:00-20:00로
               확정, 카카오톡 문의는 24시간 별도 운영(contact.html KAKAO TALK
               카드 참고). -->
          <div class="location-item">
            <strong>서울 본점 (임시 주소)</strong>
            <p>서울특별시 종로구 종로3가 10-5<br>010-3737-5757</p>
    ...
    <div class="footer-bottom">
      ...
      <!-- 대표자명·주소·전화번호 확정 반영 (2026-07-22).
           주소는 정식 주소 확정 전까지 종로3가역 인근으로 임시 표기함 —
           정식 주소 확정되면 아래 줄 교체할 것.
           통신판매업신고번호는 아직 신청 전이라 미기재 — 신고 완료 후
           "사업자등록번호: 898-26-02365" 뒤에 이어서 추가할 것. -->
      <p>© 2026 골든민트(OneTroy Bullion) 귀금속 전문점 | 대표: 정세종</p>
      <p>사업자등록번호: 898-26-02365 | 서울특별시 종로구 종로3가 10-5 (임시 주소) | 전화: 010-3737-5757</p>
