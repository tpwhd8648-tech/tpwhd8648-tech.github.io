  ...
  footer.innerHTML = `
    ...
    <div class="footer-bottom">
      ...
      <!-- 대표자명·주소·전화번호 확정 반영 (2026-07-22), 표기 방식 변경(후속).
           주소는 정식 주소 확정 전까지 종로3가역 인근 랜드마크 건물(효성주얼리시티,
           종로 183)로 표기함 — 화면 노출 텍스트에는 "임시"/"인근" 표현과 건물명은
           넣지 않고 주소만 표기(2026-07-30: 낙원상가 → 종로 183으로 교체), 실제
      ...
      <p>사업자등록번호: 898-26-02365 | 서울특별시 종로구 종로 183 | 전화: 010-3737-5757</p>
